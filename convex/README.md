...
| the adapter's `postFilter`, alone | 223 | 212 |
| folded to an unconditional plan before any filter exists | 6 | 6 |

For the 223 post-filtered actions the differential compares the adapter's CEL evaluator against the
