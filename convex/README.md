...
| the adapter's `postFilter`, alone | 248 | 237 |
| folded to an unconditional plan before any filter exists | 6 | 6 |

For the 248 post-filtered actions the differential compares the adapter's CEL evaluator against the
