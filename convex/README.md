...
| the adapter's `postFilter`, alone | 206 | 195 |
| folded to an unconditional plan before any filter exists | 6 | 6 |

For the 206 post-filtered actions the differential compares the adapter's CEL evaluator against the
