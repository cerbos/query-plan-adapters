...
describe("adversarial conformance corpus", () => {
  ...
  test("pins how much of the corpus each mapper hands to Convex's filter engine", async () => {
    ...
    expect({
      ...
      // skipping the other 215 actions there sound rather than a coverage hole.
