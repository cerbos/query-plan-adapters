 ...
 * example would be one more thing to update when the domain gains a row.
 *
...
public record DemoSeeds(List<Principal> principals,
     ...
     * the corpus so the canonical composed cases can prove the shape discriminates: applying this
     * predicate alone, or the adapter's query alone,
