...
| --- | --- |
| Oracle-tested | 60 reference conformance actions plus regex and timestamp probes (62 actions) |
| Fail-closed | 107 reference actions plus ordered list indexing/`get-field`, `int()`/`double()` casts and `filter()`/`map()` used as a condition (114 actions total) |
