...
def golden_case(case_id: str, tag: Union[str, None] = None) -> Dict[str, Any]:
...
def _response_dict(
    case: Dict[str, Any], planned_at: Union[str, None]
) -> Dict[str, Any]:
    return {
        "requestId": "",
...
def plan_from_golden(
    case: Dict[str, Any], planned_at: Union[str, None] = None
