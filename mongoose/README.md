...
The adapter is differentially tested against Cerbos PDP 0.54.0 `checkResource` decisions using the canonical check resources and real MongoDB 7 and 8 queries.
