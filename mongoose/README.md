...
| --- | --- |
| Oracle-tested | 190 reference conformance actions plus regex, ordered indexing/`get-field`, timestamp and mixed-null field-to-field probes (194 actions) |
| Fail-closed | 87 reference actions plus the 7 reference-unsupported shapes (94 actions total) |
