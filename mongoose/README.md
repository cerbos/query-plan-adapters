...
| --- | --- |
| Oracle-tested | 99 reference conformance actions plus regex, ordered indexing/`get-field`, and timestamp probes (102 actions) |
| Fail-closed | 37 reference actions plus the 5 reference-unsupported shapes (42 actions total) |
