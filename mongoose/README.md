...
| --- | --- |
| Oracle-tested | 143 reference conformance actions plus regex, ordered indexing/`get-field`, timestamp and mixed-null field-to-field probes (147 actions) |
| Fail-closed | 44 reference actions plus the 6 reference-unsupported shapes (50 actions total) |
