...
// sorted.
//
// Sorted because demo/expected.json is: a SELECT whose ORDER BY does not cover every row it returns
...
func run(ctx context.Context) error {
	...
	application := &app{cerbos: cerbosClient, pool: pool, seeds: corpus}
