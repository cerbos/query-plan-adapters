...
internal val ADVERSARIAL_TABLES: List<Table> =
    listOf(Resources, Parents, Inners, Tags, Categories, SubCategories, Labels)
...
internal val MAPPING: AttributeMappings = cerbosMapping {
    ...
    "request.resource.attr.aDouble" to Resources.aDouble
    "request.resource.attr.aOptionalString" to Resources.aOptionalString
    ...
    "request.resource.attr.parent" to one(Parents, from = Resources.id, to = Parents.resourceId) {
        ...
        "aOptionalString" to Parents.aOptionalString
        "inner" to one(Inners, from = Parents.id, to = Inners.parentId) {
            ...
            "aOptionalString" to Inners.aOptionalString
        }
    }
