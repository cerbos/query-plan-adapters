...
[`../src/test`](../src/test)'s question, answered by replaying the hostile corpus's recorded PDP
decisions on every store that adapter's workflow executes; the policy here is
