import { Prisma, PrismaClient } from "./generated/prisma-adversarial-mysql-v5";

import { adversarialDatabaseUrl } from "./test-setup.adversarial-url";

// Prisma 5 reads the datasource URL from the schema's `env("DATABASE_URL")`, which the jest
