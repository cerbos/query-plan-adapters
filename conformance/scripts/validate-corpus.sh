...
# `gradle` is absent too: no file references a Gradle image, and an entry nothing references trips
# the vacuity guard below. Both Java adapters pin Gradle through their committed wrapper.
IMAGE_REPOSITORIES=(
  "postgres"
  "mysql"
  "mongo"
