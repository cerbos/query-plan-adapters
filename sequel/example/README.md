# Sequel example application

> [!WARNING]
> The Sequel adapter is a **work-in-progress prototype** — unreleased, unused in
...
```bash
../../demo/scripts/run-example.sh sequel
```
...
Sequel release inside the gemspec's declared range reach this job at all, which is the point
